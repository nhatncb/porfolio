  ...
  return (
    <div className="flex">
      <div className="flex flex-col rounded-lg data-container black-border w-[124px] h-[124px]">
        <div className="year-container text-white text-center bg-[black] py-1 px-[10px] rounded-tr-lg rounded-tl-lg font-bold">
          2023
        </div>
      ...
      <div className="info-container flex-1 ml-6">
        ...
        <div className="flex gap-2 mt-3">
          <ClockIcon />
          <div className="text-sm flex-1">Thursday, March 16th, 2023 at 12:45pm - 2:15pm</div>
        </div>
